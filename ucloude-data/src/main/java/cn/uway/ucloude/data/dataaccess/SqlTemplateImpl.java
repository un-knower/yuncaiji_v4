...
import cn.uway.ucloude.data.dataaccess.exception.StateException;
...
public class SqlTemplateImpl  implements SqlTemplate {
	...
	private final static DbHelper dbRunner = new DbHelper();

    public SqlTemplateImpl(DataSource dataSource,String provider) {
