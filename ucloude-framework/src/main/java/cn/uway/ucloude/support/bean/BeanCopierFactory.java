...
import cn.uway.ucloude.compiler.Compiler;
import cn.uway.ucloude.exceptions.UCloudeRuntimeException;
...
import cn.uway.ucloude.utils.ReflectionUtils;
...
public final class BeanCopierFactory {
    ...
    private static final ILogger LOGGER = LoggerManager.getLogger(BeanCopierFactory.class);
    ...
    public static <Source, Target> BeanCopier<Source, Target> createCopier(
        ...
        try {
            ...
            throw new UCloudeRuntimeException("Generate BeanCopier error, sourceClass=" + sourceClass.getName() + ", targetClass=" + targetClass.getName(), e);
        }
    }
                        ...
                        if (!deepCopy) {
                            ...
                            if (ClassHelper.isPrimitiveType(targetFieldClass) || ClassHelper.isPrimitiveWrapperType(targetFieldClass)
                                ...
                                methodCode.append("target.").append(setMethod.getName()).append("(")
                                        ...
                                        .append(BeanUtil.class.getName()).append(".deepClone(")
