package cn.uway.ucloude.data.criteria;

import java.util.ArrayList;
import java.util.List;

import cn.uway.ucloude.data.criteria.Criterion.Condition;
...
private String database;
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addCriterion(Condition condition, String column) {
            if (condition == null || StringUtil.isEmpty(column)) {
        ...
        protected void addCriterion(Condition condition, Object value, String typeHandler, String column) {
            if (value == null || condition == null || StringUtil.isEmpty(column)) {
