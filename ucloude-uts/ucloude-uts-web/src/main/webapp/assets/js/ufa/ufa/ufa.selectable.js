(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, Widget = ufa.ui.Widget, proxy = $.proxy, abs = Math.abs, ARIASELECTED = 'aria-selected', SELECTED = 'k-state-selected', ACTIVE = 'k-state-selecting', SELECTABLE = 'k-selectable', CHANGE = 'change', NS = '.ufaSelectable', UNSELECTING = 'k-state-unselecting', INPUTSELECTOR = 'input,a,textarea,.k-multiselect-wrap,select,button,a.k-button>.k-icon,button.k-button>.k-icon,span.k-icon.k-i-expand,span.k-icon.k-i-collapse', msie = ufa.support.browser.msie, supportEventDelegation = false;
        (function ($) {
            (function () {
        ...
        var Selectable = Widget.extend({
            init: function (element, options) {
                ...
                that.userEvents = new ufa.UserEvents(that.element, {
                    global: true,
                    allowSelection: true,
            ...
            _select: function (e) {
                if (this._allowSelection(e.event.target)) {
                    if (!msie || msie && !$(ufa._activeElement()).is(INPUTSELECTOR)) {
                        e.preventDefault();
                    }
                }
            },
        ...
        function collision(element, position) {
            ...
            var elementPosition = ufa.getOffset(element), right = position.left + position.width, bottom = position.top + position.height;
