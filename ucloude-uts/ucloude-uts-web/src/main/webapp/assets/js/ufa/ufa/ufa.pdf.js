...
(function (f, define) {
    ...
    (function (window, parseFloat, undefined) {
            ...
            self.render = function () {
                ...
                out(new PDFDictionary({
                    ...
                    Info: new PDFDictionary({
                        Producer: new PDFString(getOption('producer', 'ufa UI PDF Generator v.' + ufa.version)),
                        ...
                        Creator: new PDFString(getOption('creator', 'ufa UI PDF Generator v.' + ufa.version)),
            ...
            if (font) {
                ...
                loadBinary(url, function (data) {
                    if (data == null) {
                        ...
                        var font = new ufa.pdf.TTFFont(data);
                        FONT_CACHE[url] = font;
                        cont(font);
                    }
                });
        ...
        function loadImage(url, cont) {
            ...
            function _load(url) {
                img.src = url;
                if (img.complete && !ufa.support.browser.msie) {
                    _onload();
                } else {
                    img.onload = _onload;
            ...
            render: function (out) {
                ...
                out.withIndent(function () {
                    for (var code = self.firstChar; code <= self.lastChar; ++code) {
                        ...
                        var str = ufa.util.ucs2encode([unicode]);
    ...
    (function (window) {
        ...
        Subfont.prototype = {
            use: function (ch) {
                var self = this;
                if (typeof ch == 'string') {
                    return ufa.util.ucs2decode(ch).reduce(function (ret, code) {
...
(function (f, define) {
    ...
    (function (ufa, $) {
        ...
        var TEXT_RENDERING_MODE = ufa.pdf.TEXT_RENDERING_MODE;
        var DASH_PATTERNS = {
            dash: [4],
            dashDot: [
                4,
        ...
        function render(group, callback) {
            ...
            group.traverse(function (element) {
                dispatch({
                    ...
                    Text: function (element) {
                        var style = ufa.pdf.parseFontDef(element.options.font);
                        var url = ufa.pdf.getFontURL(style);
            ...
            var count = 2;
            ufa.pdf.loadFonts(fonts, doIt);
            ufa.pdf.loadImages(images, doIt);
        }
        ...
        function saveAs(group, filename, proxy, callback) {
            if (window.Blob && !ufa.support.browser.safari) {
        ...
        function drawText(element, page) {
            ...
            page.beginText();
            page.setFont(ufa.pdf.getFontURL(style), style.fontSize);
        ...
        function parseColor(x) {
            var color = ufa.parseColor(x, true);
    ...
    (function (ufa, $) {
        ufa.PDFMixin = {
            ...
            _drawPDF: function (progress) {
                ...
                ufa.drawing.drawDOM(this.wrapper).done(function (group) {
                    var args = {
                        page: group,
                        pageNumber: 1,
                        progress: 1,
            ...
            _drawPDFShadow: function (settings, drawOptions) {
                ...
                var defer = $.Deferred();
                setTimeout(function () {
                    var promise = ufa.drawing.drawDOM(shadow, drawOptions);
