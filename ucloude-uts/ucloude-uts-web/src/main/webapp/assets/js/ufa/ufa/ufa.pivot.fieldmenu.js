(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, ui = ufa.ui, MENU = 'ufaContextMenu', proxy = $.proxy, NS = '.ufaPivotFieldMenu', Widget = ui.Widget;
        var PivotFieldMenu = Widget.extend({
            ...
            _layout: function () {
                ...
                this.wrapper = $(ufa.template(MENUTEMPLATE)({
                    ns: ufa.ns,
            ...
            _initFilterForm: function () {
                ...
                this._filterOperator = new ufa.ui.DropDownList(filterForm.find('select'));
            ...
            _dataSource: function () {
                this.dataSource = ufa.data.PivotDataSource.create(this.options.dataSource);
            },
            _createWindow: function () {
                var messages = this.options.messages;
                this.includeWindow = $(ufa.template(WINDOWTEMPLATE)({ messages: messages })).on('click' + NS, '.k-button-ok', proxy(this._applyIncludes, this)).on('click' + NS, '.k-button-cancel', proxy(this._closeWindow, this));
            ...
            _select: function (e) {
                var item = $(e.item);
                $('.k-pivot-filter-window').not(this.includeWindow.element).ufaWindow('close');
