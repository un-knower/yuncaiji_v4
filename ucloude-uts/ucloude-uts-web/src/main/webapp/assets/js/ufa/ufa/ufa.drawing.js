...
(function (f, define) {
    ...
    (function () {
        var math = Math, pow = math.pow, ufa = window.ufa, Class = ufa.Class, deepExtend = ufa.deepExtend, ObserversMixin = ufa.mixins.ObserversMixin, util = ufa.util, defined = util.defined, rad = util.rad, deg = util.deg, round = util.round;
        ...
        function toMatrix(value) {
            if (value && ufa.isFunction(value.matrix)) {
                return value.matrix();
            }
            return value;
        }
        ...
        ufa.dataviz.geometry = ufa.geometry;
    }());
    return window.ufa;
}, typeof define == 'function' && define.amd ? define : function (a1, a2, a3) {
    (a3 || a2)();
...
(function (f, define) {
    ...
    (function ($) {
        var noop = $.noop, toString = Object.prototype.toString, ufa = window.ufa, Class = ufa.Class, Widget = ufa.ui.Widget, deepExtend = ufa.deepExtend, util = ufa.util, defined = util.defined;
        var Surface = Widget.extend({
            init: function (element, options) {
                ...
                this._visual = new ufa.drawing.Group();
        ...
        var OptionsStore = Class.extend({
            ...
            get: function (field) {
                return ufa.getter(field, true)(this);
            },
            set: function (field, value) {
                var current = ufa.getter(field, true)(this);
                if (current !== value) {
        ...
        deepExtend(OptionsStore.fn, ufa.mixins.ObserversMixin);
        ...
        SurfaceFactory.prototype = {
            ...
            create: function (element, options) {
                ...
                ufa.logToConsole('Warning: Unable to create ufa UI Drawing Surface. Possible causes:\n' + '- The browser does not support SVG, VML and Canvas. User agent: ' + navigator.userAgent + '\n' + '- The ufa UI scripts are not fully loaded');
            }
        };
        ...
        ufa.dataviz.drawing = ufa.drawing;
    }(window.ufa.jQuery));
}, typeof define == 'function' && define.amd ? define : function (a1, a2, a3) {
    (a3 || a2)();
}));
(function (f, define) {
    ...
    (function () {
        var ufa = window.ufa, deepExtend = ufa.deepExtend, defined = ufa.util.defined;
...
(function (f, define) {
    ...
    (function ($) {
        var ufa = window.ufa, Class = ufa.Class, deepExtend = ufa.deepExtend, g = ufa.geometry, Point = g.Point, Size = g.Size, Matrix = g.Matrix, toMatrix = g.toMatrix, drawing = ufa.drawing, OptionsStore = drawing.OptionsStore, math = Math, pow = math.pow, util = ufa.util, append = util.append, arrayLimits = util.arrayLimits, defined = util.defined, last = util.last, valueOrDefault = util.valueOrDefault, ObserversMixin = ufa.mixins.ObserversMixin, inArray = $.inArray, push = [].push, pop = [].pop, splice = [].splice, shift = [].shift, slice = [].slice, unshift = [].unshift, defId = 1, START = 'start', END = 'end', HORIZONTAL = 'horizontal';
        ...
        var Layout = Group.extend({
            init: function (rect, options) {
                Group.fn.init.call(this, ufa.deepExtend({}, this._defaults, options));
                this._rect = rect;
                this._fieldMap = {};
            },
            _defaults: {
...
(function (f, define) {
    ...
    (function ($) {
        var ufa = window.ufa, drawing = ufa.drawing, geometry = ufa.geometry, Class = ufa.Class, Point = geometry.Point, deepExtend = ufa.deepExtend, trim = $.trim, util = ufa.util, last = util.last;
...
(function (f, define) {
    ...
    (function ($) {
        var doc = document, ufa = window.ufa, deepExtend = ufa.deepExtend, g = ufa.geometry, d = ufa.drawing, BaseNode = d.BaseNode, util = ufa.util, defined = util.defined, isTransparent = util.isTransparent, renderAttr = util.renderAttr, renderAllAttr = util.renderAllAttr, renderTemplate = util.renderTemplate, inArray = $.inArray;
        var BUTT = 'butt', DASH_ARRAYS = d.DASH_ARRAYS, GRADIENT = 'gradient', NONE = 'none', NS = '.ufa', SOLID = 'solid', SPACE = ' ', SVG_NS = 'http://www.w3.org/2000/svg', TRANSFORM = 'transform', UNDEFINED = 'undefined';
        var Surface = d.Surface.extend({
            ...
            translate: function (offset) {
                var viewBox = ufa.format('{0} {1} {2} {3}', Math.round(offset.x), Math.round(offset.y), this._size.width, this._size.height);
                this._offset = offset;
        ...
        var PathNode = Node.extend({
            ...
            template: renderTemplate('<path #= d.renderStyle() # #= d.renderOpacity() # ' + '#= ufa.util.renderAttr(\'d\', d.renderData()) # ' + '#= d.renderStroke() # ' + '#= d.renderFill() # ' + '#= d.renderDefinitions() # ' + '#= d.renderTransform() #></path>')
        });
        ...
        var TextNode = PathNode.extend({
            ...
            renderContent: function () {
                ...
                content = ufa.htmlEncode(content);
                return content;
            },
        ...
        function baseUrl() {
            ...
            if (base && !ufa.support.browser.msie) {
                if (hashIndex !== -1) {
...
(function (f, define) {
    ...
    (function ($) {
        var doc = document, ufa = window.ufa, deepExtend = ufa.deepExtend, util = ufa.util, defined = util.defined, isTransparent = util.isTransparent, renderTemplate = util.renderTemplate, valueOrDefault = util.valueOrDefault, g = ufa.geometry, d = ufa.drawing, BaseNode = d.BaseNode;
        ...
        var RootNode = GroupNode.extend({
            init: function (canvas) {
                ...
                this.invalidate = ufa.throttle(function () {
                    ufa.animationFrame(invalidateHandler);
                }, FRAME_DELAY);
            },
            destroy: function () {
        ...
        function addGradientStops(gradient, stops) {
            ...
            for (idx = 0; idx < stops.length; idx++) {
                stop = stops[idx];
                color = ufa.parseColor(stop.color());
                color.a *= stop.opacity();
                gradient.addColorStop(stop.offset(), color.toCssRgba());
            }
        }
        ufa.support.canvas = function () {
            return !!doc.createElement('canvas').getContext;
        }();
        if (ufa.support.canvas) {
...
(function (f, define) {
    ...
    (function ($) {
        var doc = document, math = Math, atan2 = math.atan2, ceil = math.ceil, sqrt = math.sqrt, ufa = window.ufa, deepExtend = ufa.deepExtend, noop = $.noop, d = ufa.drawing, BaseNode = d.BaseNode, g = ufa.geometry, toMatrix = g.toMatrix, Color = ufa.Color, util = ufa.util, isTransparent = util.isTransparent, defined = util.defined, deg = util.deg, round = util.round, valueOrDefault = util.valueOrDefault;
        var NONE = 'none', NS = '.ufa', COORDINATE_MULTIPLE = 100, COORDINATE_SIZE = COORDINATE_MULTIPLE * COORDINATE_MULTIPLE, GRADIENT = 'gradient', TRANSFORM_PRECISION = 4;
        var Surface = d.Surface.extend({
            init: function (element, options) {
                d.Surface.fn.init.call(this, element, options);
                enableVML();
        ...
        var ClipObserver = ufa.Class.extend({
        ...
        var ObserverNode = Node.extend({
            ...
            clipRect: function () {
                ...
                if (clip) {
                    ...
                    clipRect = ufa.format('rect({0}px {1}px {2}px {3}px)', topLeft.y, bottomRight.x, bottomRight.y, topLeft.x);
                }
                return clipRect;
            },
        ...
        ufa.support.vml = function () {
            var browser = ufa.support.browser;
            return browser.msie && browser.version < 9;
        }();
        var EMPTY_CLIP = 'inherit';
        if (ufa.support.browser.msie && ufa.support.browser.version < 8) {
...
(function (f, define) {
    ...
    (function ($, parseFloat, Math) {
        ...
        var browser = ufa.support.browser;
        var romanNumeral = ufa.util.arabicToRoman;
        var ufa_PSEUDO_ELEMENT = 'ufa-PSEUDO-ELEMENT';
        var IMAGE_CACHE = {};
        var nodeInfo = {};
        ...
        function drawDOM(element, options) {
            ...
            if (ufa.pdf) {
                ufa.pdf.defineFont(getFontFaces(element.ownerDocument));
            }
            ...
            cacheImages(element, function () {
                ...
                var paperOptions = hasPaperSize && ufa.pdf.getPaperOptions(function (key, def) {
            ...
            function makeTemplate(template) {
                if (template != null) {
                    if (typeof template == 'string') {
                        template = ufa.template(template.replace(/^\s+|\s+$/g, ''));
                    }
            ...
            function handlePageBreaks(callback, element, forceBreak, pageWidth, pageHeight, margin, options) {
                ...
                var container = doc.createElement('ufa-PDF-DOCUMENT');
                var adjust = 0;
                ...
                $(copy).find('ol').each(function () {
                    $(this).children().each(function (index) {
                        this.setAttribute('ufa-split-index', index);
                    });
                });
                $(container).css({
                    display: 'block',
                    ...
                    for (var el = element.firstChild; el; el = el.nextSibling) {
                        if (el.nodeType == 1) {
                            ...
                            if (fall == 1) {
                                ...
                                if (jqel.data('ufaChart') || /^(?:img|tr|iframe|svg|object|canvas|input|textarea|select|video|h[1-6])/i.test(el.tagName)) {
                                    breakAtElement(el);
                                } else {
                                    splitElement(el);
                                }
                ...
                function makePage() {
                    var page = doc.createElement('ufa-PDF-PAGE');
                    $(page).css({
                        display: 'block',
                        boxSizing: 'content-box',
        ...
        var parseBackgroundImage = function () {
            ...
            function parse(input) {
                ...
                function read_stop() {
                    var color = ufa.parseColor(input, true);
                    var length, percent;
                    if (color) {
        ...
        function _renderWithPseudoElements(element, group) {
            if (element.tagName == ufa_PSEUDO_ELEMENT) {
            ...
            function pseudo(kind, place) {
                ...
                if (style.content && style.content != 'normal' && style.content != 'none' && style.width != '0px') {
                    var psel = element.ownerDocument.createElement(ufa_PSEUDO_ELEMENT);
            ...
            function drawBullet() {
                ...
                function _drawBullet(f) {
                    saveStyle(element, function () {
                        ...
                        var bullet = element.ownerDocument.createElement(ufa_PSEUDO_ELEMENT);
                ...
                function elementIndex(f) {
                    ...
                    var k = element.getAttribute('ufa-split-index');
                    if (k != null) {
        ...
        function maybeRenderWidget(element, group) {
            if (element.getAttribute(ufa.attr('role'))) {
        ...
        function renderFormField(element, group) {
            ...
            var doc = element.ownerDocument;
            var el = doc.createElement(ufa_PSEUDO_ELEMENT);
            var option;
            ...
            if (tag == 'select') {
                if (element.multiple) {
                    for (var i = 0; i < element.options.length; ++i) {
                        option = doc.createElement(ufa_PSEUDO_ELEMENT);
        ...
        function renderText(element, node, group) {
            ...
            function drawText(str, box) {
                if (browser.msie && !isNaN(lineHeight)) {
                    var size = ufa.util.measureText(str, { font: font });
    ...
    }(window.ufa.jQuery, parseFloat, Math));
}, typeof define == 'function' && define.amd ? define : function (a1, a2, a3) {
    (a3 || a2)();
}));
(function (f, define) {
    ...
    (function ($) {
        var noop = $.noop, ufa = window.ufa, Class = ufa.Class, util = ufa.util, animationFrame = ufa.animationFrame, deepExtend = ufa.deepExtend;
...
(function (f, define) {
    ...
    var __meta__ = {
        ...
        name: 'Drawing API',
        category: 'framework',
        description: 'The ufa UI low-level drawing API',
        depends: [
            'core',
            'color'
        ]
