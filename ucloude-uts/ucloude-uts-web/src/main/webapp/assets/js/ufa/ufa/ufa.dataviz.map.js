...
(function (f, define) {
    define('dataviz/map/location', ['ufa.drawing'], f);
}(function () {
    (function ($, undefined) {
        var math = Math, abs = math.abs, atan = math.atan, atan2 = math.atan2, cos = math.cos, max = math.max, min = math.min, sin = math.sin, tan = math.tan, ufa = window.ufa, Class = ufa.Class, dataviz = ufa.dataviz, deepExtend = ufa.deepExtend, util = ufa.util, defined = util.defined, deg = util.deg, rad = util.rad, round = util.round, sqr = util.sqr, valueOrDefault = util.valueOrDefault;
        var Location = Class.extend({
            ...
            destination: function (distance, bearing, datum) {
                ...
                var dToR = distance / ufa.dataviz.map.datums.WGS84.a;
        ...
        Location.fn.toString = function () {
            return ufa.format(this.FORMAT, this.lat, this.lng);
        };
...
(function (f, define) {
    define('dataviz/map/attribution', ['ufa.drawing'], f);
}(function () {
    (function () {
        var ufa = window.ufa, Widget = ufa.ui.Widget, template = ufa.template, valueOrDefault = ufa.util.valueOrDefault, defined = ufa.util.defined;
        ...
        ufa.dataviz.ui.plugin(Attribution);
    }(window.ufa.jQuery));
}, typeof define == 'function' && define.amd ? define : function (a1, a2, a3) {
    (a3 || a2)();
}));
(function (f, define) {
    define('dataviz/map/navigator', ['ufa.core'], f);
}(function () {
    (function ($) {
        var ufa = window.ufa;
        ...
        var NS = '.ufaNavigator';
        function button(dir) {
            return ufa.format('<button class="k-button k-navigator-{0}">' + '<span class="k-icon k-i-arrow-{0}"/>' + '</button>', dir);
        }
        ...
        var Navigator = Widget.extend({
            init: function (element, options) {
                ...
                var parentElement = this.element.parent().closest('[' + ufa.attr('role') + ']');
        ...
        ufa.dataviz.ui.plugin(Navigator);
    }(window.ufa.jQuery));
}, typeof define == 'function' && define.amd ? define : function (a1, a2, a3) {
    (a3 || a2)();
}));
(function (f, define) {
    define('dataviz/map/zoom', ['ufa.core'], f);
}(function () {
    (function ($) {
        var ufa = window.ufa;
        var Widget = ufa.ui.Widget;
        ...
        function button(dir, symbol) {
            return ufa.format('<button class="k-button k-zoom-{0}" title="zoom-{0}">{1}</button>', dir, symbol);
        }
        var NS = '.ufaZoomControl';
        ...
        ufa.dataviz.ui.plugin(ZoomControl);
    }(window.ufa.jQuery));
}, typeof define == 'function' && define.amd ? define : function (a1, a2, a3) {
    (a3 || a2)();
}));
(function (f, define) {
    ...
    (function ($, undefined) {
        var math = Math, atan = math.atan, exp = math.exp, pow = math.pow, sin = math.sin, log = math.log, tan = math.tan, ufa = window.ufa, Class = ufa.Class, dataviz = ufa.dataviz, deepExtend = ufa.deepExtend, g = ufa.geometry, Point = g.Point, map = dataviz.map, Location = map.Location, util = ufa.util, rad = util.rad, deg = util.deg, limit = util.limitValue;
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var proxy = $.proxy, ufa = window.ufa, Class = ufa.Class, dataviz = ufa.dataviz, deepExtend = ufa.deepExtend, Extent = dataviz.map.Extent, util = ufa.util, defined = util.defined;
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var proxy = $.proxy, ufa = window.ufa, Class = ufa.Class, DataSource = ufa.data.DataSource, dataviz = ufa.dataviz, deepExtend = ufa.deepExtend, last = ufa.util.last, defined = ufa.util.defined, g = ufa.geometry, d = ufa.drawing, Group = d.Group, map = dataviz.map, Location = map.Location, Layer = map.layers.Layer;
        var ShapeLayer = Layer.extend({
            init: function (map, options) {
                ...
                this._initRoot();
                this.movable = new ufa.ui.Movable(this.surface.element);
                this._markers = [];
            ...
            setDataSource: function (dataSource) {
                ...
                this.dataSource = ufa.data.DataSource.create(dataSource);
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, getter = ufa.getter, dataviz = ufa.dataviz, deepExtend = ufa.deepExtend, util = ufa.util, defined = util.defined, g = ufa.geometry, d = ufa.drawing, map = dataviz.map, Location = map.Location, ShapeLayer = map.layers.ShapeLayer;
        ...
        var SqrtScale = ufa.Class.extend({
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var math = Math, proxy = $.proxy, ufa = window.ufa, Class = ufa.Class, template = ufa.template, dataviz = ufa.dataviz, deepExtend = ufa.deepExtend, g = ufa.geometry, Point = g.Point, Layer = dataviz.map.layers.Layer, util = ufa.util, round = util.round, renderSize = util.renderSize, limit = util.limitValue;
        var TileLayer = Layer.extend({
            ...
            _activate: function () {
                ...
                if (!ufa.support.mobileOS) {
                    if (!this._pan) {
                        this._pan = ufa.throttle(proxy(this._render, this), 100);
                    }
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, dataviz = ufa.dataviz, deepExtend = ufa.deepExtend, defined = ufa.util.defined, Extent = dataviz.map.Extent, Location = dataviz.map.Location, TileLayer = dataviz.map.layers.TileLayer, TileView = dataviz.map.layers.TileView;
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var doc = document, math = Math, indexOf = $.inArray, proxy = $.proxy, ufa = window.ufa, Class = ufa.Class, DataSource = ufa.data.DataSource, Tooltip = ufa.ui.Tooltip, dataviz = ufa.dataviz, deepExtend = ufa.deepExtend, map = dataviz.map, Location = map.Location, Layer = map.layers.Layer;
        var MarkerLayer = Layer.extend({
            ...
            _load: function (data) {
                this._data = data;
                this.clear();
                var getLocation = ufa.getter(this.options.locationField);
                var getTitle = ufa.getter(this.options.titleField);
                for (var i = 0; i < data.length; i++) {
                    var dataItem = data[i];
                    this.bind({
            ...
            _markerClick: function (e) {
                var args = {
                    marker: $(e.target).data('ufaMarker'),
                    layer: this
                };
        ...
        var Marker = Class.extend({
            ...
            render: function () {
                if (!this.element) {
                    ...
                    this.element = $(doc.createElement('span')).addClass('k-marker k-marker-' + ufa.toHyphens(options.shape || 'pin')).attr('title', options.title).attr(options.attributes || {}).data('ufaMarker', this).css('zIndex', options.zIndex);
                    if (layer) {
            ...
            renderTooltip: function () {
                ...
                if (options && Tooltip) {
                    ...
                    if (template) {
                        var contentTemplate = ufa.template(template);
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var doc = document, math = Math, min = math.min, pow = math.pow, proxy = $.proxy, ufa = window.ufa, Widget = ufa.ui.Widget, deepExtend = ufa.deepExtend, dataviz = ufa.dataviz, ui = dataviz.ui, g = ufa.geometry, Point = g.Point, map = dataviz.map, Extent = map.Extent, Location = map.Location, EPSG3857 = map.crs.EPSG3857, util = ufa.util, defined = util.defined, limit = util.limitValue, renderPos = util.renderPos, valueOrDefault = util.valueOrDefault;
        ...
        var Map = Widget.extend({
            ...
            _initScroller: function () {
                ...
                var scroller = this.scroller = new ufa.mobile.ui.Scroller(this.element.children(0), {
                    friction: friction,
...
(function (f, define) {
    ...
    var __meta__ = {
        ...
        name: 'Map',
        category: 'dataviz',
        description: 'The ufa DataViz Map displays spatial data',
        depends: [
            'data',
            'userevents',
            'tooltip',
