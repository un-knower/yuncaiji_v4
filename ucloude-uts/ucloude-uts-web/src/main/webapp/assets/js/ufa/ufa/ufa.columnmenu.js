(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, ui = ufa.ui, proxy = $.proxy, extend = $.extend, grep = $.grep, map = $.map, inArray = $.inArray, ACTIVE = 'k-state-selected', ASC = 'asc', DESC = 'desc', CHANGE = 'change', INIT = 'init', SELECT = 'select', POPUP = 'ufaPopup', FILTERMENU = 'ufaFilterMenu', MENU = 'ufaMenu', NS = '.ufaColumnMenu', Widget = ui.Widget;
        function trim(text) {
        ...
        var ColumnMenu = Widget.extend({
            init: function (element, options) {
                ...
                that.field = element.attr(ufa.attr('field'));
                that.title = element.attr(ufa.attr('title'));
            ...
            _createMenu: function () {
                ...
                that.wrapper.html(ufa.template(template)({
                    ns: ufa.ns,
            ...
            _createMobileMenu: function () {
                var that = this, options = that.options;
                var html = ufa.template(mobileTemplate)({
                    ns: ufa.ns,
                    field: that.field,
            ...
            _angularItems: function (action) {
                ...
                that.angular(action, function () {
                    var items = that.wrapper.find('.k-columns-item input[' + ufa.attr('field') + ']').map(function () {
            ...
            _columns: function () {
                ...
                if (that.options.columns) {
                    ...
                    that.menu.bind(SELECT, function (e) {
                        ...
                        field = input.attr(ufa.attr('field'));
            ...
            _updateColumnsMenu: function () {
                ...
                var fieldAttr = ufa.attr('field'), lockedAttr = ufa.attr('locked'), visible = grep(this._ownerColumns(), function (field) {
                        return !field.hidden;
            ...
            _updateColumnsLockedState: function () {
                ...
                var lockedAttr = ufa.attr('locked');
