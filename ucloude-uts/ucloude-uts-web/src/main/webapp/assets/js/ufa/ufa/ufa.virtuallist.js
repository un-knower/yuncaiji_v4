(function (f, define) {
    define('ufa.virtuallist', ['ufa.data'], f);
}(function () {
    var __meta__ = {
        id: 'virtuallist',
        name: 'VirtualList',
    ...
    (function ($, undefined) {
        var ufa = window.ufa, ui = ufa.ui, Widget = ui.Widget, DataBoundWidget = ui.DataBoundWidget, proxy = $.proxy, WRAPPER = 'k-virtual-wrap', VIRTUALLIST = 'k-virtual-list', CONTENT = 'k-virtual-content', LIST = 'k-list', HEADER = 'k-group-header', VIRTUALITEM = 'k-virtual-item', ITEM = 'k-item', HEIGHTCONTAINER = 'k-height-container', GROUPITEM = 'k-group', SELECTED = 'k-state-selected', FOCUSED = 'k-state-focused', HOVER = 'k-state-hover', CHANGE = 'change', CLICK = 'click', LISTBOUND = 'listBound', ITEMCHANGE = 'itemChange', ACTIVATE = 'activate', DEACTIVATE = 'deactivate', VIRTUAL_LIST_NS = '.VirtualList';
        ...
        function getDefaultItemHeight() {
            ...
            lineHeight = parseFloat(ufa.getComputedStyles(mockList.find('.k-item')[0], ['line-height'])['line-height']);
            mockList.remove();
            return lineHeight;
        }
        ...
        var VirtualList = DataBoundWidget.extend({
            init: function (element, options) {
                ...
                that._promisesList = [];
                that._optionID = ufa.guid();
                that.setDataSource(options.dataSource);
                that.content.on('scroll' + VIRTUAL_LIST_NS, ufa.throttle(function () {
                    that._renderItems();
            ...
            _templates: function () {
                ...
                for (var key in templates) {
                    if (typeof templates[key] !== 'function') {
                        templates[key] = ufa.template(templates[key]);
                    }
                }
        ...
        ufa.ui.VirtualList = VirtualList;
        ufa.ui.plugin(VirtualList);
    }(window.ufa.jQuery));
    return window.ufa;
