    ...
    (function ($, parseInt, undefined) {
        ...
        var ColorPalette = ColorSelector.extend({
            init: function (element, options) {
                ...
                that._selectedID = (options.ariaId || ufa.guid()) + '_selected';
        ...
        var FlatColorPicker = ColorSelector.extend({
            ...
            _sliders: function () {
                ...
                that._hueSlider = element.find('.k-hue-slider').ufaSlider({
                    min: 0,
                    max: 359,
                    tickPlacement: 'none',
                    showButtons: false,
                ...
                that._opacitySlider = element.find('.k-transparency-slider').ufaSlider({
                    min: 0,
                    max: 100,
                    tickPlacement: 'none',
                    showButtons: false,
            ...
            _hsvArea: function () {
                ...
                that._hsvEvents = new ufa.UserEvents(hsvRect, {
                    global: true,
                    press: function (e) {
                        this.offset = ufa.getOffset(hsvRect);
        ...
        var ColorPicker = Widget.extend({
            ...
            _template: ufa.template('<span role="textbox" aria-haspopup="true" class="k-widget k-colorpicker k-header">' + '<span class="k-picker-wrap k-state-default">' + '# if (toolIcon) { #' + '<span class="k-tool-icon #= toolIcon #">' + '<span class="k-selected-color"></span>' + '</span>' + '# } else { #' + '<span class="k-selected-color"></span>' + '# } #' + '<span class="k-select" unselectable="on">' + '<span class="k-icon k-i-arrow-s" unselectable="on"></span>' + '</span>' + '</span>' + '</span>'),
            options: {
                name: 'ColorPicker',
                palette: null,
                columns: 10,
            ...
            _getPopup: function () {
                ...
                if (!popup) {
                    ...
                    that._popup = popup = selector.wrapper.ufaPopup({
                        anchor: that.wrapper,
                        adjustSize: {
                            width: 5,
                            height: 0
