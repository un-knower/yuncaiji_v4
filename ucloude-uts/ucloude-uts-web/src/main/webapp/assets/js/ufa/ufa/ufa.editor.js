...
(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, Class = ufa.Class, Widget = ufa.ui.Widget, os = ufa.support.mobileOS, browser = ufa.support.browser, extend = $.extend, proxy = $.proxy, deepExtend = ufa.deepExtend, NS = '.ufaEditor', keys = ufa.keys;
        var ToolTemplate = Class.extend({
            ...
            getHtml: function () {
                ...
                return ufa.template(options.template, { useWithBlock: false })(options);
            }
        });
        var EditorUtils = {
        ...
        var Editor = Widget.extend({
            init: function (element, options) {
                var that = this, value, editorNS = ufa.ui.editor, toolbarContainer, toolbarOptions, type;
                var domElement;
                ...
                that.undoRedoStack = new ufa.util.UndoRedoStack();
                ...
                that.value(value || ufa.ui.editor.emptyElementContent);
            ...
            _selectionChange: function () {
                if (!browser.msie) {
                    ufa.ui.editor.Dom.ensureTrailingBreaks(this.body);
                }
            ...
            _resizable: function () {
                ...
                if (isResizable && this.textarea) {
                    ...
                    this.wrapper.ufaResizable(extend({}, this.options.resizable, {
                        start: function (e) {
            ...
            _spellCorrect: function (editor) {
                ...
                $(editor.body).on('contextmenu' + NS, function () {
                    ...
                    editor._spellCorrectTimeout = setTimeout(function () {
                        beforeCorrection = new ufa.ui.editor.RestorePoint(editor.getRange());
                        falseTrigger = false;
                    }, 10);
                    ...
                    if (ufa.support.browser.mozilla && !falseTrigger) {
                        falseTrigger = true;
                        return;
                    }
                    ufa.ui.editor._finishUpdate(editor, beforeCorrection);
                });
            },
            _initializeContentElement: function () {
                ...
                if (ufa.support.touch) {
                    $(doc).on('selectionchange' + NS, proxy(this._selectionChange, this)).on('keydown' + NS, function () {
                        if (ufa._activeElement() != doc.body) {
                            editor.window.focus();
                        }
                    });
                }
                ...
                $(editor.body).on('dragstart' + NS, false).on('keydown' + NS, function (e) {
                    ...
                    var dom = ufa.ui.editor.Dom, range;
            ...
            _focusOutside: function () {
                if (ufa.support.browser.msie && this.textarea) {
            ...
            state: function (toolName) {
                ...
                var RangeUtils = ufa.ui.editor.RangeUtils;
                var range, textNodes;
                if (finder) {
                    range = this.getRange();
            ...
            value: function (html) {
                var body = this.body, editorNS = ufa.ui.editor, currentHtml = editorNS.Serializer.domToXhtml(body, this.options.serialization);
                if (html === undefined) {
                    return currentHtml;
                }
                if (html == currentHtml) {
            ...
            saveSelection: function (range) {
                ...
                if (container == body || $.contains(body, container)) {
                    this.selectionRestorePoint = new ufa.ui.editor.RestorePoint(range);
                }
            },
            _focusBody: function () {
                var body = this.body;
            ...
            encodedValue: function () {
                return ufa.ui.editor.Dom.encode(this.value());
            },
            createRange: function (document) {
                return ufa.ui.editor.RangeUtils.createRange(document || this.document);
            },
            getSelection: function () {
                return ufa.ui.editor.SelectionUtils.selectionFromDocument(this.document);
            },
            ...
            selectedHtml: function () {
                return ufa.ui.editor.Serializer.domToXhtml(this.getRange().cloneContents());
            },
            paste: function (html, options) {
                this.focus();
                var command = new ufa.ui.editor.InsertHtmlCommand($.extend({
                    range: this.getRange(),
                    html: html
                }, options));
                command.editor = this;
            ...
            exec: function (name, params) {
                ...
                if (!name) {
                    throw new Error('ufaEditor.exec(): `name` parameter cannot be empty');
                }
        ...
        var FormatTool = Tool.extend({
            ...
            command: function (commandArguments) {
                var that = this;
                return new ufa.ui.editor.FormatCommand(extend(commandArguments, { formatter: that.options.formatter }));
            },
        ...
        if (ufa.PDFMixin) {
            ufa.PDFMixin.extend(Editor.prototype);
            Editor.prototype._drawPDF = function () {
                return ufa.drawing.drawDOM(this.body, this.options.pdf);
            };
            Editor.prototype.saveAsPDF = function () {
                ...
                this._drawPDF(progress).then(function (root) {
                    ...
                    return ufa.drawing.exportPDF(root, options);
...
(function (f, define) {
    ...
    (function ($) {
        var ufa = window.ufa, map = $.map, extend = $.extend, browser = ufa.support.browser, STYLE = 'style', FLOAT = 'float', CSSFLOAT = 'cssFloat', STYLEFLOAT = 'styleFloat', CLASS = 'class', KMARKER = 'k-marker';
        ...
        var Dom = {
            ...
            attrEquals: function (node, attributes) {
                for (var key in attributes) {
                    var value = node[key];
                    if (key == FLOAT) {
                        value = node[ufa.support.cssFloat ? CSSFLOAT : STYLEFLOAT];
                    }
            ...
            scrollContainer: function (doc) {
                ...
                if (ufa.support.browser.webkit || scrollContainer.compatMode == 'BackCompat') {
            ...
            unstyle: function (node, value) {
                for (var key in value) {
                    if (key == FLOAT) {
                        key = ufa.support.cssFloat ? CSSFLOAT : STYLEFLOAT;
                    }
                    node.style[key] = '';
                }
                ...
                $(body).find('p').each(function () {
                    ...
                    if (/^\s*$/g.test(p.text()) && !p.find('img,input').length) {
                        ...
                        if (node.nodeType == 1 && !dom.empty[dom.name(node)]) {
                            node.innerHTML = ufa.ui.editor.emptyElementContent;
                        }
                    }
                });
            },
                ...
                function attr(node, attributes) {
                    ...
                    for (i = 0, l = attributes.length; i < l; i++) {
                        ...
                        if (name == 'style') {
                            ...
                            result.push(ufa.htmlEncode(node.getAttribute(name, 2)));
                        } else {
...
(function (f, define) {
    ...
    (function ($) {
        var ufa = window.ufa, Class = ufa.Class, extend = $.extend, Editor = ufa.ui.editor, browser = ufa.support.browser, dom = Editor.Dom, findNodeIndex = dom.findNodeIndex, isDataNode = dom.isDataNode, findClosestAncestor = dom.findClosestAncestor, getNodeLength = dom.getNodeLength, normalize = dom.normalize;
        var SelectionUtils = {
        ...
        var RangeUtils = {
            ...
            stringify: function (range) {
                return ufa.format('{0}:{1} - {2}:{3}', dom.name(range.startContainer), range.startOffset, dom.name(range.endContainer), range.endOffset);
            },
...
(function (f, define) {
    ...
    (function ($) {
        var ufa = window.ufa, Class = ufa.Class, editorNS = ufa.ui.editor, EditorUtils = editorNS.EditorUtils, registerTool = EditorUtils.registerTool, dom = editorNS.Dom, Tool = editorNS.Tool, ToolTemplate = editorNS.ToolTemplate, RestorePoint = editorNS.RestorePoint, Marker = editorNS.Marker, extend = $.extend;
        ...
        var Command = Class.extend({
            ...
            createDialog: function (content, options) {
                ...
                return $(content).appendTo(document.body).ufaWindow(extend({}, editor.options.dialogOptions, options)).closest('.k-window').toggleClass('k-rtl', ufa.support.isRtl(editor.wrapper)).end();
            },
            exec: function () {
        ...
        var InsertHtmlTool = Tool.extend({
            ...
            update: function (ui) {
                var selectbox = ui.data('ufaSelectBox') || ui.find('select').data('ufaSelectBox');
                selectbox.close();
            ...
            createColGroup: function (row) {
                ...
                colgroup = $($.map(cells, function (cell) {
                    ...
                    if (width && parseInt(width, 10) !== 0) {
                        return ufa.format('<col style="width:{0}px;"/>', width);
                    }
                    return '<col />';
                }).join(''));
...
(function (f, define) {
    ...
    (function ($) {
        var ufa = window.ufa, Class = ufa.Class, Editor = ufa.ui.editor, formats = ufa.ui.Editor.fn.options.formats, EditorUtils = Editor.EditorUtils, Tool = Editor.Tool, ToolTemplate = Editor.ToolTemplate, FormatTool = Editor.FormatTool, dom = Editor.Dom, RangeUtils = Editor.RangeUtils, extend = $.extend, registerTool = Editor.EditorUtils.registerTool, registerFormat = Editor.EditorUtils.registerFormat, KMARKER = 'k-marker';
        ...
        var GreedyInlineFormatter = InlineFormatter.extend({
            init: function (format, values, greedyProperty) {
                ...
                if (greedyProperty) {
                    this.greedyProperty = ufa.toCamelCase(greedyProperty);
                }
            },
            activate: function (range, nodes) {
        ...
        var FontTool = DelayedExecutionTool.extend({
            init: function (options) {
                Tool.fn.init.call(this, options);
                this.type = ufa.support.browser.msie || ufa.support.touch ? 'ufaDropDownList' : 'ufaComboBox';
        ...
        var ColorTool = Tool.extend({
            ...
            initialize: function (ui, initOptions) {
                ...
                ui = this._widget = new ufa.ui.ColorPicker(ui, {
...
(function (f, define) {
    ...
    (function ($) {
        var ufa = window.ufa, Class = ufa.Class, extend = $.extend, Editor = ufa.ui.editor, formats = ufa.ui.Editor.fn.options.formats, dom = Editor.Dom, Command = Editor.Command, ToolTemplate = Editor.ToolTemplate, FormatTool = Editor.FormatTool, EditorUtils = Editor.EditorUtils, registerTool = EditorUtils.registerTool, registerFormat = EditorUtils.registerFormat, RangeUtils = Editor.RangeUtils;
...
(function (f, define) {
    ...
    (function ($) {
        var ufa = window.ufa, extend = $.extend, editorNS = ufa.ui.editor, dom = editorNS.Dom, Command = editorNS.Command, Tool = editorNS.Tool, BlockFormatter = editorNS.BlockFormatter, normalize = dom.normalize, RangeUtils = editorNS.RangeUtils, registerTool = editorNS.EditorUtils.registerTool;
...
(function (f, define) {
    ...
    (function ($) {
        var ufa = window.ufa, Class = ufa.Class, extend = $.extend, Editor = ufa.ui.editor, dom = Editor.Dom, RangeUtils = Editor.RangeUtils, EditorUtils = Editor.EditorUtils, Command = Editor.Command, ToolTemplate = Editor.ToolTemplate, FormatTool = Editor.FormatTool, BlockFormatFinder = Editor.BlockFormatFinder, textNodes = RangeUtils.textNodes, registerTool = Editor.EditorUtils.registerTool;
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, Class = ufa.Class, extend = $.extend, proxy = $.proxy, Editor = ufa.ui.editor, dom = Editor.Dom, RangeUtils = Editor.RangeUtils, EditorUtils = Editor.EditorUtils, Command = Editor.Command, Tool = Editor.Tool, ToolTemplate = Editor.ToolTemplate, InlineFormatter = Editor.InlineFormatter, InlineFormatFinder = Editor.InlineFormatFinder, textNodes = RangeUtils.textNodes, registerTool = Editor.EditorUtils.registerTool;
        ...
        var LinkCommand = Command.extend({
            ...
            exec: function () {
                ...
                this._dialog = dialog.data('ufaWindow').center().open();
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, extend = $.extend, Editor = ufa.ui.editor, EditorUtils = Editor.EditorUtils, dom = Editor.Dom, registerTool = EditorUtils.registerTool, ToolTemplate = Editor.ToolTemplate, RangeUtils = Editor.RangeUtils, Command = Editor.Command, LinkFormatter = Editor.LinkFormatter, textNodes = RangeUtils.textNodes, keys = ufa.keys, KEDITORFILEURL = '#k-editor-file-url', KEDITORFILETITLE = '#k-editor-file-title';
        ...
        ufa.ui.editor.FileCommand = FileCommand;
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, extend = $.extend, Editor = ufa.ui.editor, EditorUtils = Editor.EditorUtils, dom = Editor.Dom, registerTool = EditorUtils.registerTool, ToolTemplate = Editor.ToolTemplate, RangeUtils = Editor.RangeUtils, Command = Editor.Command, keys = ufa.keys, KEDITORIMAGEURL = '#k-editor-image-url', KEDITORIMAGETITLE = '#k-editor-image-title', KEDITORIMAGEWIDTH = '#k-editor-image-width', KEDITORIMAGEHEIGHT = '#k-editor-image-height';
        var ImageCommand = Command.extend({
            ...
            exec: function () {
                ...
                dialog = this.createDialog(that._dialogTemplate(showBrowser), dialogOptions).toggleClass('k-filebrowser-dialog', showBrowser).find('.k-dialog-insert').click(apply).end().find('.k-dialog-close').click(close).end().find('.k-edit-field input').keydown(keyDown).end().find(KEDITORIMAGEURL).val(img ? img.getAttribute('src', 2) : 'http://').end().find(KEDITORIMAGETITLE).val(img ? img.alt : '').end().find(KEDITORIMAGEWIDTH).val(imageWidth).end().find(KEDITORIMAGEHEIGHT).val(imageHeight).end().data('ufaWindow');
                if (showBrowser) {
                    this._imageBrowser = new ufa.ui.ImageBrowser(dialog.element.find('.k-imagebrowser'), extend({}, imageBrowser, {
                        change: function () {
        ...
        ufa.ui.editor.ImageCommand = ImageCommand;
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, DropDownList = ufa.ui.DropDownList, dom = ufa.ui.editor.Dom;
        var SelectBox = DropDownList.extend({
            init: function (element, options) {
                var that = this;
                DropDownList.fn.init.call(that, element, options);
                if (ufa.support.mobileOS.ios) {
        ...
        ufa.ui.plugin(SelectBox);
        ufa.ui.editor.SelectBox = SelectBox;
    }(window.ufa.jQuery));
}, typeof define == 'function' && define.amd ? define : function (a1, a2, a3) {
    (a3 || a2)();
}));
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, extend = $.extend, Editor = ufa.ui.editor, EditorUtils = Editor.EditorUtils, Command = Editor.Command, Tool = Editor.Tool, ToolTemplate = Editor.ToolTemplate;
        var ViewHtmlCommand = Command.extend({
            ...
            exec: function () {
                var that = this, editor = that.editor, messages = editor.options.messages, dialog = $(ufa.template(ViewHtmlCommand.template)(messages)).appendTo(document.body), content = ViewHtmlCommand.indent(editor.value()), textarea = '.k-editor-textarea';
                function apply(e) {
                ...
                this.createDialog(dialog, {
                    ...
                    close: close,
                    visible: false
                }).find(textarea).val(content).end().find('.k-dialog-update').click(apply).end().find('.k-dialog-close').click(close).end().data('ufaWindow').center().open();
        ...
        ufa.ui.editor.ViewHtmlCommand = ViewHtmlCommand;
...
(function (f, define) {
    ...
    (function ($) {
        var ufa = window.ufa, Editor = ufa.ui.editor, Tool = Editor.Tool, ToolTemplate = Editor.ToolTemplate, DelayedExecutionTool = Editor.DelayedExecutionTool, Command = Editor.Command, dom = Editor.Dom, EditorUtils = Editor.EditorUtils, RangeUtils = Editor.RangeUtils, registerTool = EditorUtils.registerTool;
        var FormattingTool = DelayedExecutionTool.extend({
            init: function (options) {
                var that = this;
                Tool.fn.init.call(that, ufa.deepExtend({}, that.options, options));
                that.type = 'ufaSelectBox';
                that.finder = {
                    getFormat: function () {
                        return '';
                    }
            ...
            initialize: function (ui, initOptions) {
                ...
                ui.ufaSelectBox({
                    ...
                    highlightFirst: false,
                    template: ufa.template('<span unselectable="on" style="display:block;#=(data.style||"")#">#:data.text#</span>')
                });
...
(function (f, define) {
    ...
    (function ($, undefined) {
        ...
        var keys = ufa.keys;
        var NS = '.ufaEditor';
        var EditorUtils = ufa.ui.editor.EditorUtils;
        var ToolTemplate = ufa.ui.editor.ToolTemplate;
        var Tool = ufa.ui.editor.Tool;
        ...
        var Toolbar = Widget.extend({
            init: function (element, options) {
                ...
                if (options.resizable && options.resizable.toolbar) {
                    that._resizeHandler = ufa.onResize(function () {
                        that.resize();
                    });
            ...
            _initPopup: function () {
                this.window = $(this.element).wrap('<div class=\'editorToolbarWindow k-header\' />').parent().prepend('<button class=\'k-button k-button-bare k-editortoolbar-dragHandle\'><span class=\'k-icon k-i-move\' /></button>').ufaWindow({
                    title: false,
                    resizable: false,
            ...
            _initOverflowPopup: function (ui) {
                ...
                that.overflowPopup = $(popupTemplate).appendTo('body').ufaPopup({
                    anchor: ui,
                    origin: 'bottom right',
                    position: 'top right',
            ...
            bindTo: function (editor) {
                ...
                that.element.find('.k-combobox .k-input').keydown(function (e) {
                    var combobox = $(this).closest('.k-combobox').data('ufaComboBox'), key = e.keyCode;
            ...
            isCustomTool: function (toolName) {
                return !(toolName in ufa.ui.Editor.defaultTools);
            },
            expandTools: function (tools) {
                var currentTool, i, nativeTools = this._nativeTools, options, defaultTools = ufa.deepExtend({}, ufa.ui.Editor.defaultTools), result = {}, name;
            ...
            render: function () {
                var that = this, tools = that.tools, options, template, toolElement, toolName, editorElement = that._editor.element, element = that.element.empty(), groupName, newGroupName, toolConfig = that._editor.options.tools, browser = ufa.support.browser, group, i, groupPosition = 0, resizable = that.options.resizable && that.options.resizable.toolbar, overflowFlaseTools = this.overflowFlaseTools;
            ...
            decorateFrom: function (body) {
                this.items().filter('.k-decorated').each(function () {
                    var selectBox = $(this).data('ufaSelectBox');
                    if (selectBox) {
            ...
            destroy: function () {
                ...
                if (this._resizeHandler) {
                    ufa.unbindResize(this._resizeHandler);
                }
            ...
            refreshTools: function () {
                var that = this, editor = that._editor, range = editor.getRange(), nodes = ufa.ui.editor.RangeUtils.textNodes(range);
                if (!nodes.length) {
...
(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, extend = $.extend, proxy = $.proxy, Editor = ufa.ui.editor, dom = Editor.Dom, EditorUtils = Editor.EditorUtils, RangeUtils = Editor.RangeUtils, Command = Editor.Command, NS = '.ufaEditor', ACTIVESTATE = 'k-state-active', SELECTEDSTATE = 'k-state-selected', Tool = Editor.Tool, ToolTemplate = Editor.ToolTemplate, InsertHtmlCommand = Editor.InsertHtmlCommand, BlockFormatFinder = Editor.BlockFormatFinder, registerTool = Editor.EditorUtils.registerTool;
        ...
        var PopupTool = Tool.extend({
            initialize: function (ui, options) {
                Tool.fn.initialize.call(this, ui, options);
                var popup = $(this.options.popupTemplate).appendTo('body').ufaPopup({
                    anchor: ui,
                    copyAnchorStyles: false,
        ...
        var InsertTableTool = PopupTool.extend({
            ...
            _activate: function () {
                var that = this, element = that._popup.element, cells = element.find('.k-ct-cell'), firstCell = cells.eq(0), lastCell = cells.eq(cells.length - 1), start = ufa.getOffset(firstCell), end = ufa.getOffset(lastCell), cols = that.cols, rows = that.rows, cellWidth, cellHeight;
            ...
            _setTableSize: function (size) {
                ...
                if (this._valid(size)) {
                    status.text(ufa.format(messages.createTableHint, size.row, size.col));
