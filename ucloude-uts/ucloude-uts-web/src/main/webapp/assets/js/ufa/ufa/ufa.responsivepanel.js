(function (f, define) {
    define('ufa.responsivepanel', ['ufa.core'], f);
}(function () {
    var __meta__ = {
        id: 'responsive-panel',
    ...
    (function ($, undefined) {
        ...
        var ResponsivePanel = Widget.extend({
            ...
            _registerBreakpoint: function () {
                ...
                this._registerStyle(ufa.template(this._mediaQuery)({
