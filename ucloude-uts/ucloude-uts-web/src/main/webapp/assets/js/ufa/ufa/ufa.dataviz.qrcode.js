...
(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, extend = $.extend, draw = ufa.drawing, dataviz = ufa.dataviz, Widget = ufa.ui.Widget, Box2D = dataviz.Box2D, terminator = '0000', NUMERIC = 'numeric', ALPHA_NUMERIC = 'alphanumeric', BYTE = 'byte', powersOfTwo = { '1': 0 }, powersOfTwoResult = { '0': 1 }, generatorPolynomials = [
                [
                    1,
                    0
                ],
        ...
        var QRDataMode = ufa.Class.extend({
