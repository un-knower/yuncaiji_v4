(function (f, define) {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, support = ufa.support, caret = ufa.caret, activeElement = ufa._activeElement, placeholderSupported = support.placeholder, ui = ufa.ui, List = ui.List, keys = ufa.keys, DataSource = ufa.data.DataSource, ARIA_DISABLED = 'aria-disabled', ARIA_READONLY = 'aria-readonly', CHANGE = 'change', DEFAULT = 'k-state-default', DISABLED = 'disabled', READONLY = 'readonly', FOCUSED = 'k-state-focused', SELECTED = 'k-state-selected', STATEDISABLED = 'k-state-disabled', HOVER = 'k-state-hover', ns = '.ufaAutoComplete', HOVEREVENTS = 'mouseenter' + ns + ' mouseleave' + ns, proxy = $.proxy;
