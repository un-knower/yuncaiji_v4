(function (f, define) {
    define('ufa.maskedtextbox', ['ufa.core'], f);
}(function () {
    var __meta__ = {
        id: 'maskedtextbox',
        name: 'MaskedTextBox',
    ...
    (function ($, undefined) {
        ...
        var ns = '.ufaMaskedTextBox';
        var proxy = $.proxy;
        var INPUT_EVENT_NAME = (ufa.support.propertyChangeEvent ? 'propertychange' : 'input') + ns;
        ...
        var MaskedTextBox = Widget.extend({
            ...
            _tokenize: function () {
                ...
                var numberFormat = ufa.getCulture(this.options.culture).numberFormat;
