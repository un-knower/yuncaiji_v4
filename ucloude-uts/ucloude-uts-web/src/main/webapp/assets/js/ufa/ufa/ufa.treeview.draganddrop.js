(function (f, define) {
    define('ufa.treeview.draganddrop', [
        'ufa.data',
        'ufa.draganddrop'
    ], f);
}(function () {
    ...
    (function ($, undefined) {
        ...
        ui.HierarchicalDragAndDrop = ufa.Class.extend({
            init: function (element, options) {
                ...
                this._draggable = new ui.Draggable(element, {
                    ...
                    cursorOffset: {
                        left: 10,
                        top: ufa.support.mobileOS ? -40 / ufa.support.zoomLevel() : 10
                    },
            ...
            _removeTouchHover: function () {
                if (ufa.support.touch && this.hovered) {
            ...
            drag: function (e) {
                ...
                var target = this.dropTarget = $(ufa.eventTarget(e));
                ...
                if (!container.length) {
                    ...
                    if (hoveredItem.length) {
                        ...
                        if (options.reorderable) {
                            ...
                            itemTop = ufa.getOffset(hoveredItem).top;
