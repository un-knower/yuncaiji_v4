(function (f, define) {
    define('ufa.panelbar', ['ufa.core'], f);
}(function () {
    var __meta__ = {
        id: 'panelbar',
        name: 'PanelBar',
    ...
    (function ($, undefined) {
        ...
        var PanelBar = Widget.extend({
            ...
            _insert: function (item, referenceItem, parent) {
                ...
                if (item instanceof ufa.Observable) {
                    item = item.toJSON();
                }
            ...
            _toggleGroup: function (element, visibility) {
                ...
                element.ufaStop(true, true).ufaAnimate(animation);
            },
