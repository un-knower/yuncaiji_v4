(function (f, define) {
    define('ufa.progressbar', ['ufa.core'], f);
}(function () {
    var __meta__ = {
        id: 'progressbar',
        name: 'ProgressBar',
    ...
    (function ($, undefined) {
        ...
        var ProgressBar = Widget.extend({
            ...
            _validateType: function (currentType) {
                ...
                if (!isValid) {
                    throw new Error(ufa.format('Invalid ProgressBar type \'{0}\'', currentType));
                }
            },
            _wrapper: function () {
                var that = this;
