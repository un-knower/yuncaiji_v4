...
(function (f, define) {
    define('ufa.dataviz.sparkline', ['ufa.dataviz.chart'], f);
}(function () {
    var __meta__ = {
    ...
    (function ($, undefined) {
        var ufa = window.ufa, dataviz = ufa.dataviz, Chart = dataviz.ui.Chart, ObservableArray = ufa.data.ObservableArray, SharedTooltip = dataviz.SharedTooltip, deepExtend = ufa.deepExtend, isArray = $.isArray, proxy = $.proxy, inArray = dataviz.inArray, math = Math;
