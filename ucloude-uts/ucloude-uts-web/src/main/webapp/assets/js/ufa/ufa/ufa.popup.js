    ...
    (function ($, undefined) {
        ...
        var Popup = Widget.extend({
            init: function (element, options) {
                ...
                that.element.hide().addClass('k-popup k-group k-reset k-list-scroller').toggleClass('k-rtl', !!options.isRtl).css({ position: ABSOLUTE }).appendTo(options.appendTo).on('mouseenter' + NS, function () {
                    that._hovered = true;
