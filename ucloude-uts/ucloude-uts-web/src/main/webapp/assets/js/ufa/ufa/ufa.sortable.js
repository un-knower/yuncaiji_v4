(function (f, define) {
    define('ufa.sortable', ['ufa.draganddrop'], f);
}(function () {
    var __meta__ = {
        id: 'sortable',
        name: 'Sortable',
    ...
    (function ($, undefined) {
        var ufa = window.ufa, Widget = ufa.ui.Widget, START = 'start', BEFORE_MOVE = 'beforeMove', MOVE = 'move', END = 'end', CHANGE = 'change', CANCEL = 'cancel', ACTION_SORT = 'sort', ACTION_REMOVE = 'remove', ACTION_RECEIVE = 'receive', DEFAULT_FILTER = '>*', MISSING_INDEX = -1;
        ...
        var Sortable = Widget.extend({
            ...
            _createDraggable: function () {
                ...
                return new ufa.ui.Draggable(element, {
                    filter: options.filter,
                    hint: ufa.isFunction(options.hint) ? options.hint : $(options.hint),
            ...
            _dragstart: function (e) {
                var draggedElement = this.draggedElement = e.currentTarget, disabled = this.options.disabled, handler = this.options.handler, _placeholder = this.options.placeholder, placeholder = this.placeholder = ufa.isFunction(_placeholder) ? $(_placeholder.call(this, draggedElement)) : $(_placeholder);
            ...
            _dragend: function (e) {
                ...
                if (placeholderIndex >= 0) {
                    ...
                    connectedList = placeholder.parents(connectWith).getufaSortable();
            ...
            _findElementUnderCursor: function (e) {
                var elementUnderCursor = ufa.elementUnderCursor(e), draggable = e.sender;
                if (containsOrEqualTo(draggable.hint[0], elementUnderCursor)) {
                    draggable.hint.hide();
                    elementUnderCursor = ufa.elementUnderCursor(e);
            ...
            _searchConnectedTargets: function (element, e) {
                ...
                for (var i = 0; i < connected.length; i++) {
                    sortableInstance = connected.eq(i).getufaSortable();
            ...
            _isCursorAfterLast: function (sortable, e) {
                ...
                lastItemOffset = ufa.getOffset(lastItem);
            ...
            _getElementCenter: function (element) {
                var center = element.length ? ufa.getOffset(element) : null;
                if (center) {
