package cn.uway.ucloude.uts.core.commons.concurrent.limiter;
...
import cn.uway.ucloude.uts.core.commons.concurrent.limiter.SmoothRateLimiter.SmoothBursty;
import cn.uway.ucloude.uts.core.commons.concurrent.limiter.SmoothRateLimiter.SmoothWarmingUp;
/**
...
public abstract class RateLimiter {
    ...
    public static RateLimiter create(double permitsPerSecond, long warmupPeriod, TimeUnit unit) {
        Assert.isTrue(warmupPeriod >= 0, StringUtil.format("warmupPeriod must not be negative: {}", warmupPeriod));
    ...
    private static int checkPermits(int permits) {
        ...
        Assert.isTrue(permits > 0, StringUtil.format("Requested permits ({}) must be positive", permits));
        return permits;
    }
}
