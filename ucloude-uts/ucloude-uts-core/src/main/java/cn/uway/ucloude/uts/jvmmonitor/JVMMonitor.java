...
import cn.uway.ucloude.uts.core.support.CrossClassLoader;
import cn.uway.ucloude.uts.jvmmonitor.mbean.JVMGC;
import cn.uway.ucloude.uts.jvmmonitor.mbean.JVMInfo;
import cn.uway.ucloude.uts.jvmmonitor.mbean.JVMMemory;
import cn.uway.ucloude.uts.jvmmonitor.mbean.JVMThread;

public class JVMMonitor {
	private static final ILogger LOGGER = LoggerManager.getLogger(JVMMonitor.class);
    ...
    public static void start() {
        ...
        if (start.compareAndSet(false, true)) {
            if (CollectionUtil.isEmpty(MONITOR_MAP)) {
