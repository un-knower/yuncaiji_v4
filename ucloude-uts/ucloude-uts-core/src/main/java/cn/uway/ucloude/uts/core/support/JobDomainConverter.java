...
public class JobDomainConverter {
    ...
    public static JobPo convert(Job job) {
        ...
        if (job.isRepeatable()) {
            ...
            jobPo.setInternalExtParam(ExtConfigKeys.FIRST_FIRE_TIME, String.valueOf(jobPo.getTriggerTime()));
        }
        return jobPo;
    }
    ...
    public static JobFeedbackPo convert(JobRunResult result) {
        ...
        jobFeedbackPo.setId(StringUtil.generateUUID());
