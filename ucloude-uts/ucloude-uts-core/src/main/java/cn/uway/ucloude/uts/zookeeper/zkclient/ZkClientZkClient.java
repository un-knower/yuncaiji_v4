...
import cn.uway.ucloude.uts.zookeeper.support.AbstractZkClient;
...
public class ZkClientZkClient extends AbstractZkClient<IZkChildListener, IZkDataListener> {
    ...
    public ZkClientZkClient(String registryAddress) {
        registryAddress = NodeRegistryUtils.getRealRegistryAddress(registryAddress);
