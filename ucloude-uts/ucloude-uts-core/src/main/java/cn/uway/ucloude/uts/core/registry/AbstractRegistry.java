...
public abstract class AbstractRegistry implements Registry {
	protected final static ILogger LOGGER = LoggerManager.getLogger(Registry.class);
    ...
    protected UtsContext appContext;
    private Node node;

    public AbstractRegistry(UtsContext appContext) {
