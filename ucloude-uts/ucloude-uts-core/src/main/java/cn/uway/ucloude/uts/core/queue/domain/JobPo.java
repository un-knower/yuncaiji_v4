...
public class JobPo implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2465868506992490947L;
	/**
	 * 服务端生成的jobId
	 */
	...
	public void setExtParams(String key, String value) {
	...
	public Map<String, String> getInternalExtParam() {
		return internalExtParams;
	}

	public void setInternalExtParam(Map<String, String> value) {
		internalExtParams = value;
	}
