...
import cn.uway.ucloude.uts.spring.quartz.invoke.JobDetailJobExecution;
import cn.uway.ucloude.uts.spring.quartz.invoke.MethodInvokeJobExecution;
...
class QuartzSchedulerBeanTargetEditor extends PropertyEditorSupport {
    ...
    private static final ILogger LOGGER = LoggerManager.getLogger(QuartzSchedulerBeanTargetEditor.class);
