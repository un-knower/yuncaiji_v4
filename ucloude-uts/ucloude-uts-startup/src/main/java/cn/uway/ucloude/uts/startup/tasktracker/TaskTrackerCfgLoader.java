...
public class TaskTrackerCfgLoader {
    ...
    public static TaskTrackerCfg load(String confPath) throws CfgException {
        ...
        String cfgPath = confPath + "/ucloude-uts-tasktracker.cfg";
        ...
        try {
            ...
            if (StringUtil.isNotEmpty(useSpring)) {
            ...
            String shardField = conf.getProperty("shardField");
            if (StringUtil.isNotEmpty(shardField)) {
                cfg.setShardField(shardField);
            }
