...
import cn.uway.ucloude.uts.monitor.cmd.MDataAddHttpCmd;
import cn.uway.ucloude.uts.monitor.cmd.MDataSrv;
import cn.uway.ucloude.uts.monitor.cmd.MonitorReadFileHttpCmd;
    ...
    public void start() {
        ...
        try {
            ...
            this.httpCmdServer.registerCommands(
                    ...
                    new MonitorReadFileHttpCmd(this.appContext,this.cfgPath));
            // 启动
