...
public class NettyLogger {
	public static void setNettyLoggerFactory() {
        ...
        if (factory == null || !(factory instanceof RpcLoggerFactory)) {
            InternalLoggerFactory.setDefaultFactory(new RpcLoggerFactory());
        }
    }

    private static class RpcLoggerFactory extends InternalLoggerFactory {
        @Override
        protected InternalLogger newInstance(String name) {
            return new RpcLogger(name);
        }
    }

    static class RpcLogger implements InternalLogger {
